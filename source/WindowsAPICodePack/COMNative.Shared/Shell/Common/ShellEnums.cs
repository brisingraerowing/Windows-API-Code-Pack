...
namespace Microsoft.WindowsAPICodePack.COMNative.Shell
{
    ...
    public enum ImageListDrawFlags : uint
    {
        ...
        /// <summary>
        /// To extract the overlay image from the fStyle member, use the logical AND to combine fStyle with the <see cref="OverlayMask"/> value.
        /// </summary>
