...
namespace Microsoft.WindowsAPICodePack.Shell
{
...
#endif
    {
        ...
        {
            get => string.IsNullOrEmpty(_targetLocation) && NativeShellItem2 == null ? _targetLocation : (_targetLocation = Properties.System.Link.TargetParsingPath.Value);
        ...
        public string Title
        {
            get => NativeShellItem2 == null ? null : Properties.System.Title.Value;
        ...
        {
            get => string.IsNullOrEmpty(_arguments) && NativeShellItem2 == null ? _arguments : _arguments = Properties.System.Link.Arguments.Value;
        ...
        {
            get => string.IsNullOrEmpty(_comments) && NativeShellItem2 == null ? _comments : _comments = Properties.System.Comment.Value;
