...
namespace Microsoft.WindowsAPICodePack.Dialogs.Controls
{
    ...
    public class CommonFileDialogButton : CommonFileDialogProminentControl
    {
        ...
        /// </summary>
        public CommonFileDialogButton() : base(string.Empty) { /* Left empty. */ }

        /// <summary>
        /// Initializes a new instance of this class with the text only.
        /// </summary>
        /// <param name="text">The text to display for this control.</param>
        public CommonFileDialogButton(string text) : base(text) { /* Left empty. */ }
        ...
        /// <param name="text">The text to display for this control.</param>
        public CommonFileDialogButton(string name, string text) : base(name, text) { /* Left empty. */ }
