...
namespace Microsoft.WindowsAPICodePack.COMNative.Shell.PropertySystem
{
    ...
    public static class SystemProperties
    {
        ...
        public static class System
        {
            ...
            ///
            ///If System.FileName is <see cref="VarEnum.VT_EMPTY"/>, then this property should be too.  Otherwise, it should be derived
            ...
            ///"\\server\share\numbers.xls"  ".xls"
            ///"\\server\share\folder"   <see cref="VarEnum.VT_EMPTY"/>
            ///"c:\foo\MyFolder" <see cref="VarEnum.VT_EMPTY"/>
            ///[desktop] <see cref="VarEnum.VT_EMPTY"/></para>
            /// <para>Type: <see cref="string"/> -- <see cref="VarEnum.VT_LPWSTR"/>  (For variants: <see cref="VarEnum.VT_BSTR"/>)</para>
            ...
            ///(email message)   <see cref="VarEnum.VT_EMPTY"/>
            ...
            ///
            ///If System.ItemFolderPathDisplay is <see cref="VarEnum.VT_EMPTY"/>, then this property should be too.  Otherwise, it 
            ...
            ///
            ///If System.ItemPathDisplay is <see cref="VarEnum.VT_EMPTY"/>, then this property should be too.  Otherwise, it should 
            ...
            /// <para>Description: This is the user-friendly display path of the parent folder of an item.  The format of the <see cref="string"/>
            ...
            ///
            ///If System.ItemFolderPathDisplay is <see cref="VarEnum.VT_EMPTY"/>, then this property should be too.  Otherwise, it should
            ...
            ///includes the extension in all cases, and will be localized if a localized name is available.
            ///
            ///There are acceptable cases when System.FileName is not <see cref="VarEnum.VT_EMPTY"/>, yet the value of this property 
            ...
            ///Example values:
            ///
            ///System.ItemNamePrefixSystem.ItemName  System.ItemNameDisplay
            ///----------------------------------------  ----------------------
            ///<see cref="VarEnum.VT_EMPTY"/> "Great day"  "Great day"
            ///"Re:""Great day"  "Re: Great day"
            ///"Fwd: "  "Monthly budget" "Fwd: Monthly budget"
            ///<see cref="VarEnum.VT_EMPTY"/> "accounts.xls"   "accounts.xls"</para>
            /// <para>Type: <see cref="string"/> -- <see cref="VarEnum.VT_LPWSTR"/>  (For variants: <see cref="VarEnum.VT_BSTR"/>)</para>
            ...
            /// <para>Description: This is the user-friendly display path to the item. The format of the <see cref="string"/> should be 
            ...
            ///
            ///If System.ItemType is <see cref="VarEnum.VT_EMPTY"/>, the value of this property is also <see cref="VarEnum.VT_EMPTY"/>.
            ///
            ...
            ///
            ///If the item cannot be accessed through the shell namespace, this value is <see cref="VarEnum.VT_EMPTY"/>.</para>
            /// <para>Type: <see cref="string"/> -- <see cref="VarEnum.VT_LPWSTR"/>  (For variants: <see cref="VarEnum.VT_BSTR"/>)</para>
            ...
            public static class Communication
            {
                ...
                /// <para>Description: This a <see cref="string"/> used to identify the retention policy applied to the item.
                ///</para>
                /// <para>Type: <see cref="string"/> -- <see cref="VarEnum.VT_LPWSTR"/>  (For variants: <see cref="VarEnum.VT_BSTR"/>)</para>
        ...
        #region Properties
            ...
            public static class Devices
            {
                ...
                /// <para>Description: Remaining battery life of the device and the device's charging state as a <see cref="string"/>.
                ///</para>
                /// <para>Type: <see cref="string"/> -- <see cref="VarEnum.VT_LPWSTR"/>  (For variants: <see cref="VarEnum.VT_BSTR"/>)</para>
                ...
                /// <para>Description: <see cref="bool"/> value representing if the device is currently charging.
                ///</para>
                /// <para>Type: Byte -- <see cref="VarEnum.VT_UI1"/></para>
                ...
                /// <para>Description: <see cref="string"/> representing the type of the device's network.
                ///</para>
                /// <para>Type: <see cref="string"/> -- <see cref="VarEnum.VT_LPWSTR"/>  (For variants: <see cref="VarEnum.VT_BSTR"/>)</para>
     ...
     #region Properties
            ...
            public static class Document
            {
                ...
                /// <para>Description: 100ns units, not milliseconds. <see cref="VarEnum.VT_FILETIME"/> for IPropertySetStorage handlers (legacy)
                ///</para>
                /// <para>Type: <see cref="ulong"/> -- <see cref="VarEnum.VT_UI8"/></para>
            ...
            public static class Link
            {
                ...
                ///
                ///If the target item cannot be accessed through the shell namespace, this value is <see cref="VarEnum.VT_EMPTY"/>.
                ///</para>
                /// <para>Type: <see cref="string"/> -- <see cref="VarEnum.VT_LPWSTR"/>  (For variants: <see cref="VarEnum.VT_BSTR"/>)</para>
                ...
                /// <para>Description: Expresses the SFGAO flags of a link as <see cref="string"/> values and is used as a query optimization.  See 
            ...
            public static class Media
            {
                ...
                /// <para>Description: <see cref="DateTime"/> is in UTC (in the doc, not file system).
                ///</para>
                /// <para>Type: <see cref="DateTime"/> -- <see cref="VarEnum.VT_FILETIME"/>  (For variants: <see cref="VarEnum.VT_DATE"/>)</para>
            ...
            public static class Search
            {
                ...
                /// <para>Description: The <see cref="DateTime"/> that the Windows Search Gatherer process last pushed properties of this document to the Windows Search Gatherer Plugins.
                ///</para>
                /// <para>Type: <see cref="DateTime"/> -- <see cref="VarEnum.VT_FILETIME"/>  (For variants: <see cref="VarEnum.VT_DATE"/>)</para>
            ...
            public static class Shell
            {
                ...
                /// <para>Description: Expresses the SFGAO flags as <see cref="string"/> values and is used as a query optimization.
                ///</para>
                /// <para>Type: Multivalue <see cref="string"/> -- <see cref="VarEnum.VT_VECTOR"/> | <see cref="VarEnum.VT_LPWSTR"/>  (For variants: <see cref="VarEnum.VT_ARRAY"/> | <see cref="VarEnum.VT_BSTR"/>)</para>
