...
namespace Microsoft.WindowsAPICodePack.Win32Native.Shell
{
    public static partial class Shell
    {
        ...
        /// <para>If <paramref name="uFlags"/> does not contain <see cref="ExeType"/> or <see cref="SysIconIndex"/>, the return value is nonzero if successful, or zero otherwise.</para>
        /// <para>If <paramref name="uFlags"/> contains the <see cref="ExeType"/> flag, the return value specifies the type of the executable file. It will be one of the following values.</para>
        ...
        /// <para>If <see cref="SHGetFileInfo"/> returns an icon handle in the <see cref="SHFILEINFO.hIcon"/> member of the <see cref="SHFILEINFO"/> structure pointed to by <b>psfi</b>, you are responsible for freeing it with <see cref="Core.DestroyIcon"/> when you no longer need it.</para>
